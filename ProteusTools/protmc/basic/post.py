...
from ..common.base import Summary, ParsedEntry, ShortSummary
from ..common.utils import count_sequences
...
def analyze_seq_no_rich(
    ...
    :return: a DataFrame of sequences visited during the ProteusTools run.
    """
