...
from protmc.genetic.base import Gene
...
def test_add_genes():
    ...
    g1, g2, g3 = Gene(1, 2, 'A', 'B', 1.0, 1.0), Gene(2, 3, 'A', 'C', 1.0, 0.1), Gene(2, 3, 'B', 'C', 1.0, 0.1)
    individual = GenericIndividual([g1], 0.5)
    ...
    g4 = Gene(3, 4, 'C', 'B', 1.0, 1.0)
    individual = GenericIndividual([g1, g4], 0.5)
    # No B for node 2 -> nothing happens
    individual.add_gene(g2)
    ...
    individual = GenericIndividual([g1, g4], 0.0)
